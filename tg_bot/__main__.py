        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                     [[InlineKeyboardButton(text="⭕️ MAIN GROUP ⭕️", url="https://t.me/NEW_MLM_HD_MOVES")],
                     [InlineKeyboardButton(text="⭕ UPDATE CHANNEL ⭕", url="https://t.me/mlm_movies_update")],
